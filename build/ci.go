...
import (
	...
	"github.com/Qitmeer/qit/crypto/signify"
	"github.com/Qitmeer/qit/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/Qitmeer/qit/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/Qitmeer/qit/internal/version.gitDate="+env.Date)
	}
